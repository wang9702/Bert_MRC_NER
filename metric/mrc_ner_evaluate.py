...
# (start_pred_lst, end_pred_lst, span_pred_lst,
#  start_gold_lst, end_gold_lst, span_gold_lst, ner_cate_lst, label_list, threshold=config.entity_threshold, dims=2)
def flat_ner_performance(pred_start, pred_end, pred_span, gold_start, gold_end, gold_span, ner_cate, label_lst, threshold=0.5, dims=2):
    ...
    if dims == 1:
        ...
        return average_acc, span_precision, span_recall, span_f1, pred_bmes_label_lst
    ...
    if dims == 1:
        ...
        for pred_start_item, pred_end_item, pred_span_item, gold_start_item, gold_end_item, gold_span_item, ner_cate_item in zip(
            ...
            pred_span_triple, gold_span_triple = nested_ner_performance(pred_start_item, pred_end_item, \
                pred_span_item, gold_start_item, gold_end_item, gold_span_item, ner_cate_item, label_lst, dims=1)
        ...
        return average_acc, span_precision, span_recall, span_f1, pred_span_triple_lst
